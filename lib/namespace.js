...
function CMScope(manager, scope) {
  ...
  o.prototype.create = function (o, cb) {
    return manager.create.call(manager, scope, o, cb);
  };

  o.prototype.remove = function (id) {
    return manager.remove.call(manager, id);
  };
...
console.log('returning: ', scopedManager.object);
